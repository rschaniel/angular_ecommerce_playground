...
describe('NavBarComponent', () => {
  ...
  it('should not show the back button if no back link', () => {
    ...
    expect(fixture.nativeElement.querySelector('button[data-test-selector="back-button"]')).toBeNull();
  });
  ...
  it('should show the buttons if the links are given', () => {
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.querySelector('button[data-test-selector="back-button"]')).not.toBeNull();
    expect(fixture.nativeElement.querySelector('button[data-test-selector="next-button"]')).not.toBeNull();
  });

  it('should navigate on button click', fakeAsync(() => {
    component.nextLink = 'next-page';
    fixture.detectChanges();
    fixture.nativeElement.querySelector('button[data-test-selector="next-button"]').click();
    ...
    component.backLink = 'previous-page';
    fixture.detectChanges();
    fixture.nativeElement.querySelector('button[data-test-selector="back-button"]').click();
